...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <h4 class="card-title mb-5 text-center text-bold" style="font-size: 20px!important; color:black">Add Team Member Form</h4>
                <a href="{{route('admin.team.member')}}"><button type="button" class="btn mb-3" style="background-color: #2c3e50; color:#2ecc71;"><i class="fa-solid fa-list-check"></i> Manage Blog</button></a>

                <form action="{{route('team.member.new')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row mb-4">
                        <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Member Name</label>
                        <div class="col-sm-9">
                          <input type="text" name="name" class="form-control" id="horizontal-firstname-input" placeholder="Member Name">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="designation" class="form-control" id="horizontal-designation-input" placeholder="Member Designation">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                          <textarea name="chefsabout" id="editor2" class="form-control"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        <label for="horizontal-email-input" class="col-sm-3 col-form-label">Member Image</label>
                        <div class="col-sm-9">
