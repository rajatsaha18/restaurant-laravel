    ...
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{route('category.update',['id' => $item->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img src="{{asset($item->image)}}" alt="category-image" height="70px" width="90px"/>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
