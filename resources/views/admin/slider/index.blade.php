...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <h4 class="card-title mb-5 text-center text-bold" style="font-size: 20px!important; color:black">Add Slider Form</h4>
                ...
                <form action="{{route('slider.new')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                          <textarea name="description" class="form-control" id="horizontal-firstname-input"></textarea>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
