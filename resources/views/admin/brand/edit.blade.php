...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <h4 class="card-title mb-5 text-center text-bold" style="font-size: 20px!important; color:black">Edit Brand Form</h4>
                <a href="{{route('brand.logo')}}"><button type="button" class="btn mb-3" style="background-color: #2c3e50; color:#2ecc71;"><i class="fa-solid fa-list-check"></i> Manage Gallery</button></a>
                ...
                <form action="{{route('brand.update',$brand->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img src="{{asset($brand->image)}}" alt="gallery-image" height="70px" width="90px"/>
