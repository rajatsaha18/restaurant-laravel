...
<head>
        ...
        <meta charset="utf-8" />
        <title>Register | Business Solution - Responsive Bootstrap 4 Admin Dashboard</title>
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Get your free Business Solution account now.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="{{route('register')}}" method="POST">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">By registering you agree to the Business Solution <a href="#" class="text-primary">Terms of Use</a></p>
                                        </div>
                                    </form>
                                </div>
